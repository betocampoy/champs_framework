...
if (CHAMPS_MAINTENANCE_MODE_ON && $_REQUEST['route'] != CHAMPS_SYS_MAINTENANCE_ROUTE) {
    if ($_SERVER['REMOTE_ADDR'] == '::1' && !in_array($_SERVER['REMOTE_ADDR'], CHAMPS_MAINTENANCE_MODE_IP_EXCEPTIONS)) {
