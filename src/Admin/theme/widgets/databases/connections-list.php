    ...
    <div class="card-header">
        <div class="d-flex justify-content-between">
            ...
            <button class="btn btn-primary sendForm" <?=csrf_data_attr()?> data-disable_button="false"
                    data-post="<?=$router->route("champs.admin.databasesConnectionCreate")?>">Create New</button>
        </div>
    </div>
    <div class="card-body">
        <table class="table">
                ...
                <?php foreach ($connections as $connName => $connection): ?>
                    <tr>
                        <th scope="row"><a class="btn btn-link sendForm" <?=csrf_data_attr()?>
                                           ...
                                           data-post="<?=$router->route("champs.admin.databasesConnectionEdit", ["id" => $connName])?>"
                                           href="#"><?=$connName?></a></th>
