        ...
        <form action="">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary champs_send_post_on_click" <?=csrf_data_attr()?> id="link-dbConnSave"
                            data-with_inputs="true"
                            data-route="<?= $router->route("champs.admin.databasesConnectionSave") ?>"
                            >Save changes
                    </button>
                </div>
            </div>
